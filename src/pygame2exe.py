...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Cuboid Clash"
 
        #Project url
        self.project_url = "http://www.cadryden.com"
        ...
        #Auhor of program
        self.author_name = "Chris Alvarado-Dryden"
        self.author_email = "chris@cadryden.com"
        self.copyright = "Copyright (c) 2010 Chris Alvarado-Dryden."
 
        #Description
        self.project_description = "Cuboid Clash - A CAD-E Game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "cadIcon.ico"
 
        #Extra files/dirs copied to game
        self.extra_datas = []
 
        #Extra/excludes python modules
        self.extra_modules = ["Example"]
